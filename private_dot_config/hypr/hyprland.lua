...
-- Match the display across USB-C ports and avoid overlap when it appears after eDP.
-- Directional placement also adapts when the external resolution changes.
hl.monitor({ output = "desc:Philips Consumer Electronics Company PHL 325E1", mode = "highres", position = "auto-left", scale = 1 })
hl.monitor({ output = "eDP-1", mode = "highres", position = "auto-right", scale = 1 })
